...
export const register = async(req,res)=>{
    ...
    try {
        ...
        const mailOptions={
            ...
            text: `welcome to account your account has been created with emailId: ${email}`
        }
...
export const login = async(req,res)=>{
    ...
    try {
        ...
        if(!user){
            return res.json({success:false, message:'Invalid email User does not exist. Please register.'})
        }
...
export const sendResetOtp = async (req,res)=>{
    ...
    try {
        ...
        const user= await userModel.findOne({email});
        if(!user){
            return res.sjon({success:false , message:'User not found '});
        }
